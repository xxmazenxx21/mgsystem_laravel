...
//move_uploaded_file($picture['tmp_name'],__DIR__.'/uploads/' . time() . '.' . explode('.' , $picture['name'][1]));


 $picture = $_FILES['picture']; 
 $fileName = time() . '_' . $picture['name'] ;
...
$sql = "SELECT COUNT(*) FROM `manager` WHERE `id` = ?";
$stmt = $pdo->query($sql, $managerid);
$managerExists = $stmt->fetchColumn();

if (!$managerExists) {
    $_SESSION['errors'] = ['This manager id does not exist.'];
    ...
    exit;
        ...
        $sql = "INSERT INTO `employee` (`fname`, `lname`, `email`, `phone`, `picture` , `managerid`) VALUES (?, ?, ?, ?, ? , ?)";
        $pdo->query($sql, $fname, $lname, $email, $phone, $fileName ,$managerid);
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="manager.php">managers</a>
                    </li>
    ...
    <section class="h-100 mt-5">
        <div class="card w-100 bg-transparent text-light text-center border border-light">
            ...
            <div class="card-body text-start">
                <form action="empcreate.php" method="POST" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="manager" class="form-label">managerid</label>
                        <input type="text" class="form-control" id="fname" name="managerid">
                    </div>
